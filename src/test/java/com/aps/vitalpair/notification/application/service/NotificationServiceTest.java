...
class NotificationServiceTest {
    ...
    void whatAnotherPersonDidIsAlwaysWrittenWhateverTheSwitchesSay() {
        ...
        service.create(TENANT, USER, NotificationType.PARTNER_MEAL, "Bia", "Salada", null);
        service.create(TENANT, USER, NotificationType.PARTNER_ACTIVITY, "Bia", null, 300);
    ...
    void anotificationIsWrittenUnreadWithItsOwnDetails() {
        ...
        service.create(TENANT, USER, NotificationType.PARTNER_ACTIVITY, "Bia", null, 420);
        ...
        assertThat(saved.getValue().getActorName()).isEqualTo("Bia");
