package com.aps.vitapair.tdee.application.service;
...
class TdeeServiceTest {
    ...
    void homemGanhoDeMassa() {
        ...
        TdeeResult r = service.calculate(new TdeeInput(
                Sex.MALE, 30, bd(180), bd(80), ActivityLevel.MODERATE, Goal.GAIN_MUSCLE));
    ...
    void mulherPerdaDePeso() {
        ...
        TdeeResult r = service.calculate(new TdeeInput(
                Sex.FEMALE, 25, bd(165), bd(65), ActivityLevel.LIGHT, Goal.LOSE_WEIGHT));
    ...
    void manterPesoNaoAjustaCalorias() {
        TdeeResult r = service.calculate(new TdeeInput(
                Sex.MALE, 40, bd(175), bd(75), ActivityLevel.SEDENTARY, Goal.MAINTAIN));
