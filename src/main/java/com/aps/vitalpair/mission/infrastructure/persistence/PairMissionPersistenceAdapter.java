...
public class PairMissionPersistenceAdapter implements PairMissionRepositoryPort {
    ...
    public PairMissionPersistenceAdapter(
            PairMissionJpaRepository repository, PairMissionPersistenceMapper mapper) {
    ...
    public PairMissionState save(PairMissionState state) {
        ...
        repository.findByTenantIdAndMissionDate(state.getTenantId(), state.getDate())
