...
/** Implementa {@link EmailVerificationTokenStorePort} no Redis (chave {@code emailverify:<token>} → userId, com TTL). */
@Component
public class RedisEmailVerificationTokenStore implements EmailVerificationTokenStorePort {

    private static final String KEY_PREFIX = "emailverify:";
