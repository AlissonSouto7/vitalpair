 ...
 * Confete nas 3 cores da marca (laranja=você, roxo=Bia, verde=vitória),
 * troféu com aura, placar final, aposta a pagar e recompensas.
 * Renderiza só o conteúdo: o Layout (sidebar etc.) já vem por fora.
 *
 * Lei das cores: laranja = você · roxo = Bia · verde = pontos/vitória · dourado = carb.
...
const SEASON = {
  ...
  rivalInitial: 'C',
  rivalScore: 920,
  stake: 'A Bia te paga o jantar. Combinado é combinado.',
  rewards: [
  ...
  return (
    <div className="relative -mx-4 -my-4 min-h-[calc(100vh-6rem)] overflow-hidden sm:-mx-6 sm:-my-6">
      ...
      <div className="relative z-10 mx-auto flex max-w-[520px] flex-col items-center px-4 py-10 text-center">
        ...
        >
          {youWon ? 'Você venceu!' : 'A Bia levou essa.'}
        </h1>
        <p
        ...
        >
          {youWon
            ? `Mandou bem demais! 30 dias sem desistir e ${lead} pts na frente. A Bia que se cuide na próxima.`
