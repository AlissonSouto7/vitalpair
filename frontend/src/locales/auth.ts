export const auth = {
  ...
  en: {
    ...
    errorGoogle: 'Could not sign in with Google. Try again.',
  ...
  es: {
    ...
    errorGoogle: 'No se pudo entrar con Google. Inténtalo de nuevo.',
  ...
  fr: {
    ...
    errorGoogle: 'La connexion avec Google n’a pas marché. Réessaie.',
