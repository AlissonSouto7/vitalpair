...
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------- |
| 2026-09-11 | `contato@vitalpair.app` exists: Cloudflare Email Routing forwards it to the owner's mailbox and the application sends from it. The contact address these pages have promised since they were written is now real, and the debt row saying it was not is gone                                                       | (server configuration) |
