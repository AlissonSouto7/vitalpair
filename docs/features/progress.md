...
| ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- |
| 2026-09-15 | A weight change is judged against the profile's goal instead of against zero. The chart painted any loss green and any gain orange, which is necessarily wrong for one half of a pair with opposite goals, every time they weigh themselves. `weightVerdict` decides the words and the colour together, and says nothing at all where the goal is unknown | `fix/screen-sweep`                  |
