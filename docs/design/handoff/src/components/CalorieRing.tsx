 ...
 * A ponta acende laranja quando o cronômetro/atividade está ativa (prop `active`).
 */
    ...
    <div className="relative shrink-0" style={{ width: size, height: size }}>
      <svg width={size} height={size} viewBox="0 0 120 120">
        ...
        <circle
          ...
          style={{ '--vp-off': offset, animation: 'vp-ring-draw 1.1s cubic-bezier(.4,0,.2,1) both' } as React.CSSProperties}
        />
      </svg>
