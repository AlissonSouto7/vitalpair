...
**Evite (tells de IA):**
- construções simétricas tipo "sem X, sem Y" / "não é A, é B"
- listinhas de três paralelas ("tem placar, tem streak e tem...")
- "Zero planilha", "em tempo real", "consistência", "jornada", "eleve sua..."
- stats inventados ("+120 duplas já competindo")
- em-dash decorativo e copy publicitária polida demais
- terminologia médica/dieta ou inglês desnecessário
